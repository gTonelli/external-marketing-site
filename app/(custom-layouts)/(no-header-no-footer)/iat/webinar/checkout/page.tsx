    ...
    <Page page_name="IAT Webinar Squeeze Page">
      <Section
        ...
        <div className="relative text-black text-left p-4 z-20 lg:col-span-7">
          ...
          <p className="font-bold text-xl mb-8">Join the Live IAT™ Program on May 7th, 2026</p>
          ...
          <CountdownTimer
            ...
            theme="light"
            date={getOfferEndDate(new Date('2026-05-08T17:30:00-04:00'), 1)}
          />
        ...
        <div className="grid grid-cols-1 gap-4 text-left lg:grid-cols-2">
          ...
          <div className="h-fit bg-white shadow-md rounded-xl p-4">
            <Image
              ...
              src="/images/IATWebinar/IAT-May-2026-Thumbnail.webp"
              sizes="100vw"
              quality={100}
            />
