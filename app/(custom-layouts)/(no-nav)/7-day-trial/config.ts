  ...
  courses: [
    {
      ...
      thumbnail: 'trial-page-program-emotional.jpg',
      courses: [
    ...
    },
    {
      ...
      thumbnail: 'trial-page-program-fa.jpg',
      courses: [
        'The Handbook for A Better Life',
        'Discover, Embrace & Fulfill Your Personal Needs',
    ...
    },
    {
      ...
      thumbnail: 'trial-page-program-ap.jpg',
      courses: [
        'The Handbook for A Better Life',
        'Discover, Embrace & Fulfill Your Personal Needs',
    ...
    },
    {
      ...
      thumbnail: 'trial-page-program-da.jpg',
      courses: [
    ...
    },
    {
      ...
      thumbnail: 'trial-page-program-breakup.jpg',
      courses: [
