    ...
    <Page page_name="Attachment Style Quiz">
      ...
      <Section className="bg-[#f5fbfc]">
        ...
        <div className="grid gap-8 text-left my-16 lg:grid-cols-2">
          ...
          <div>
            <h3 className="mb-4">Fearful Avoidant </h3>

            <p>
              The "hot and cold" push-pull of a Fearful Avoidant attachment style often feels like
              emotional whiplash. One minute, you're seeking closeness; the next, you're withdrawing
              in fear. This inner conflict can make relationships feel chaotic, confusing, and
              overwhelming as you feel torn between the anxieties of attachment and the need for
