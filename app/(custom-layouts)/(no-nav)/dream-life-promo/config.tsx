export const UPSELL_PAGE_CONFIG = {
  countdownBanner: {
    header:
      'LIMITED TIME: Start Your Next Step With the Emotionary Mastery Course By Taking a 7-Day Free All-Access Pass Trial',
  },
  hero: {
    header: 'Master Your Emotions & Rewrite Your Relationships & Life',
  },
  benefits: [
    {
  ...
  snippets: {
    header: 'Take a Moment For Yourself',
    copy: 'Explore some snippets of our most popular courses from each of the categories below!',
