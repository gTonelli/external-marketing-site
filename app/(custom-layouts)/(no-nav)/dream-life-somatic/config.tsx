export const JULY_PROMO_SOMATIC_CONFIG = {
  hero: {
    timerHeader:
      'FLASH SALE: Get the “Release Emotions with Somatic Processing” Course for Just $19 (Down from $250)!',
    header: 'Self-Soothe Your Emotions. Calm Your Mind. Reconnect with Yourself.',
  },
  course: {
    label: 'HURRY UP! THIS OFFER EXPIRES SOON!',
    ...
    highlight: `When you say "yes" today to this course, you'll unlock unlock calmness, clarity, and control.`,
  },
  howTo: {
    header: 'Feel Calm, Clear, and In Control From the Inside Out',
    copy1: [
      ...
      <>
        <strong>Through easy-to-follow, body-based tools, you’ll learn how to:</strong>
      </>,
    ],
    listItems: [
      ...
      'Feel safe and grounded in your body again',
    ],
    copy2: [
  ...
  features: {
    ...
    subheader: (
      <>
        <strong>
          Inside, you’ll find everything you need to start feeling calm <em>immediately</em>
        </strong>
      </>
    ),
    listLeft: [
