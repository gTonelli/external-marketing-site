export const FA_SINGLE_CONFIG = {
  ...
  versions: {
    ...
    situationship: {
      header:
        'Here’s Why You’re Always Finding Yourself Stuck in The “Grey Area” of Relationships!',
      subheader:
...
export const FA_SINGLE_SEO = {
  behaviors: {
    seoTitle: 'Fearful Avoidant Singles | Discover Your Behaviors',
    seoDescription:
      'Watch this video to get all the answers on why your relationships are always a struggle – and how this course can help you change it!',
  },
  'dating-tips': {
    seoTitle: 'Fearful Avoidant Singles | Dating Tips',
    seoDescription:
      'Dating is hard because most people are insecurely attached. But these three quick tips can help improve your Fearful avoidant dating life ASAP!',
  },
  'heal-triggers': {
    seoTitle: 'Fearful Avoidant Singles | Heal Your Triggers',
    seoDescription:
      'Watch the video now to get tools for fearless dating and heal your triggers faster than ever before! It will change your life!',
  },
  situationship: {
    seoTitle: 'Fearful Avoidant Singles | Situationships',
    seoDescription:
      'Situationships aren’t safer—they’re just emotionally draining in a different way. Here is how you can escape the cycle of situationships and find true love!',
  },
  'dating-apps': {
    seoTitle: 'Fearful Avoidant Singles | How to Use Dating Apps',
    seoDescription:
      'Do you have Tinder trauma? Learn how to stop swiping and start seriously reflecting on your dating habits with these life-changing habits and course!',
  },
  needs: {
