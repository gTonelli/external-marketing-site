export const IAT_CONFIG = {
  banner: {
    ...
    subtitle: 'WITH THE INTEGRATED ATTACHMENT THEORY™ CERTIFICATION PROGRAM',
    copy1:
    ...
    copy3:
      '*Sign up for the Live Training, starting December 1, 2025 to February 16, 2026. Spots are limited.',
  },
  intro: {
  ...
  formats: {
    title: 'Here is How You Can Learn About Integrated Attachment Theory™',
    subtitle: 'CHOOSE BETWEEN LIVE AND ON-DEMAND TRAINING OPTIONS',
    copy: 'The Integrated Attachment Theory™ Program is conducted online with two formats available: Live with Thais Gibson or On-Demand with recorded videos. Both lead to the same certification but offer different levels of support and flexibility.',
  },
  certification: {
    title: 'The Integrated Attachment Theory™ Certification Is For You If:',
    forYouBullets: [
  ...
  thais: {
    ...
    copy: [
      'Trusted by over 1.5 million students worldwide, global attachment theory leader Thais Gibson shares the exclusive tools and strategies developed from 10+ years of experience and groundbreaking research: Integrated Attachment Theory™.',
      ...
      'Her success with Integrated Attachment Theory™ led her to create The Personal Development School, where the ground-breaking techniques in rapid transformation and healing relationships can be accessed through courses and programs.',
  ...
  impact: {
    ...
    bullets: [
      ...
      'What does life look like in 1 year, 2 years, or 5 years if you don’t gain the knowledge offered in the Integrated Attachment Theory™ Program, so you can design the life you want?',
      'How would you feel knowing you can help anyone, anywhere in the world, live their best lives with the best relationships?',
    ],
    copy: 'You have the opportunity to answer those questions by enrolling in the Integrated Attachment Theory™ Certification Program.',
  },
}
