export const LIFETIME = {
  HERO_SECTION: {
    ...
    promo_text: 'SAVE UP TO $600 TODAY',
  },
  SITUATION_SECTION: {
  ...
  UNLOCK_SECTION: {
    header: 'You’ll Unlock Instant Access to:',
    bullets: [
  ...
  MEMBERSHIP_SECTION: {
    ...
    text: `You\’re amazing! Since you’ve made it all the way here, we know one thing about you; you are dedicated to changing.  You are a tenacious and brave person.  And you will 100% make it.\n
    ...
    bullets: [
      {
        ...
        text: 'You see your romantic relationships improve or experience more joy, trust, and fulfillment if you’re single – and get ready to attract your ideal partner.',
      },
      {
        img: 'lifetime_level-up_icon2.png',
        text: 'You become part of a supportive, non-judgmental community of people who get you and your dedication to growth.',
      },
      {
        img: 'lifetime_level-up_icon3.png',
        text: 'You build more self-compassion and self-love and, as a result, get the courage to go for your dreams.',
      },
    ],
  },
  COURSE_BENEFITS_SECTION: {
    header: 'Conquer Any Area of Your Life Any Time',
    subheader:
