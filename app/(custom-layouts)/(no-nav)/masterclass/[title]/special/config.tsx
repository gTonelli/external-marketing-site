...
export const CONFIG = {
  ...
  'rebuild-trust': {
    ...
    hero: {
      title:
        'Heal Your Trust Wounds, Navigate the Aftermath of Being Cheated On, and If You Choose to Stay — Rebuild a Relationship You Can Actually Trust',
      copy: 'Join The Personal Development School and access a full library of courses, tools, and live group coaching sessions. Understand why the cheating happened and heal the trust wounds it created — so you can make a clear decision about your relationship and move forward without doubt.',
      videoId: '546da06755eb846463a99dd3b4e9f493',
      thumbnailSrc:
        'https://pds-strapi-bucket.s3.ca-central-1.amazonaws.com/thais_writing_video_thumbnail_a5e6bc6f9e.jpg',
      videoLabel:
    ...
    transformationJourney: {
      title: 'This is How Real Healing Happens',
      intro: [
        `Lasting change doesn't come from forcing yourself to "just get over it." It comes from understanding why the pain keeps showing up the way it does, and learning how to actually move through it instead of around it.`,
      ],
      items: [
