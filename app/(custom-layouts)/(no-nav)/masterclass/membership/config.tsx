export const CONFIG = {
  countdown: {
    title: 'Claim Your Special Discount From The Personal Development School Here',
  ...
  aboutMembership: [
    'As a Personal Development School Member, you gain access to a complete system for healing, growth, and transformation, starting from the inside out.',
    'Go beyond surface-level self-help and rewire the patterns that shape your relationships, emotional world, and sense of self. Inside PDS, you’ll learn how to heal core wounds, communicate your needs effectively, build healthy boundaries, and regulate your nervous system for lasting change.',
    'Each program is rooted in proven psychological frameworks and guided by world-class teaching designed to create real, measurable transformation.',
    'You’ll also gain access to powerful tools, structured pathways for growth, and a deeply supportive community of individuals committed to doing the inner work.',
    'The Personal Development School gives you everything you need to transform your relationships, with yourself and others, and create lasting change in every area of your life.',
  ],
  features: {
    ...
    list: [
      {
        ...
        copy: (
          <>
            ...
            designed to help you improve communication, understand relationship dynamics, and create
            stronger emotional connection in your life.
          </>
        ),
      },
      {
  ...
  testimonials: {
    title: 'Stories from Members of The Personal Development School',
  },
  noRiskMembership: {
  ...
  pricing: {
    title: 'Start Your Growth Journey Today with The Personal Development School',
    ...
    items: [
      ...
      <>
        ...
        and step-by-step techniques designed to help you shift patterns and improve how you respond
