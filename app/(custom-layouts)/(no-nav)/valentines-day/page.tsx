    ...
    <Page page_name="Valentine's Day" className="w-full overflow-hidden">
      ...
      <Section
        ...
        <div className="col-start-2 text-left">
          ...
          <p className="mb-4">
            Our comprehensive two-week free trial provides you access to ALL of our courses
          ...
          <p className="mb-4">
            ...
            romantic relationships, love life, and dating journey and experience real and profound
            progress!
          </p>
        </div>
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-4">
          <div className="text-left">
            ...
            <p className="mb-4">
              ...
              feeling overwhelmed by different goals and emotions. Or you're in a rut of hopeless
              and mindless dates.
            </p>
          ...
          <div className="lg:grid lg:grid-cols-4 lg:gap-6">
            <div>
              ...
              <p className="w-3/4 mx-auto lg:w-auto">
                Can I constantly let my need for independence and freedom ruin my chance at real
                love?
              </p>
            </div>
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center lg:my-8">
          ...
          <div className="text-left">
            ...
            <List
              ...
              icon={faCircleCheck}
              listItems={[
                `**A library of powerful video courses** to manage your emotions, conquer challenges, and repair your relationships — just in time for Valentine's Day.`,
...
const STEPS_TO_PURCHASE = [
  {
    ...
    copy: 'Start your transformation today with a 14-day free trial of the All-Access Pass Membership. You will have two full weeks to explore everything The Personal Development School has to offer, including courses, live webinars Q&As, and much more.',
  ...
  },
  {
    ...
    copy: 'Your Attachment Style Course is your first step toward mastering secure and fulfilled relationships. With this foundation, you can continue building meaningful connections, improving your dating life, and strengthening your self-care with our other courses – for FREE for 14 days!',
    image: '/images/TrialHeadspace/pds-courses-mockup.png',
  },
]
