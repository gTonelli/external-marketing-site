export const AB_CART_COPY = {
    ...
    shared: {
      ...
      faqs: {
        common: [
          {
            question: 'Can I join this training if I have no prior coaching experience? Is it a good fit for me and my current career goals?',
          ...
          {
            question: 'Will I be learning the exact coaching strategy and tools used by Thais Gibson with her coaching clients?',
