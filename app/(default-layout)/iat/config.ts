...
export const IAT_COPY = {
  ...
  relationship_section: {
    ...
    copy_left: `The Gibson Integrated Attachment Theory™ Certification Course is a revolutionary relationship coaching certification developed by Thais Gibson.
                ...
                \n***Spots for the Live Training version of the program running from May 1 - July 17, 2024 are limited.**`,
    ...
    live_training: {
      prerequisite_week: {
        ...
        week1: [
          ...
          `Attend 1-hour review session on May 1st, 6 PM ET`,
        ],

        week2: [
          `Complete course: Emotional Mastery Course Part 1`,

          `Attend 1-hour review session on May 8th, 6 PM ET`,
        ],

        week3: [
          `Complete course: Emotional Mastery Course Part 2`,

          `Attend 1-hour review session on May 15th, 6 PM ET`,
        ],

        week4: [
          `Complete course: Discover, Embrace and Fulfil Your Personal Needs`,

          `Attend 1-hour review session on May 22nd, 6 PM ET`,
        ],
      },
      ...
      intensive_week: {
        ...
        copy: `After completing your prerequisites and content course webinars, you’ll start your live training with Thais from May 29 - July 17 every Wednesday at 6 PM ET for 8 weeks.
