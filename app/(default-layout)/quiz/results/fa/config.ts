    ...
    PROMOTION_1: {
      ...
      bullets: {
        left: [
          ...
          {
            text: 'Your insecurities/fears (with tools to overcome them),',
            text_bold: 'so that you can feel confident and stable in your love life.',
          },
          {
            text: 'Expectations',
            text_bold:
        ...
        right: [
          ...
          {
            text: 'Strategies you need to communicate and interact with others',
            text_bold:
              'so that you can have the quality of relationship you actually want to be in.',
          },
          {
            text: "It ALSO gives you specific tools to quickly recognize others' attachment styles and to understand their needs, fears and boundaries",
            text_bold: 'so that you can feel safe trusting others and letting your guard down.',
          },
        ],
      },
