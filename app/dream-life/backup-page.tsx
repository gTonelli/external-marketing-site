...
// //modules
// import { ERoutes, EWindowWidth } from 'utils'
...
// let isVariant = Storage.get('gm-755-headspace-split') === 'yes'
...
//         <h2 className="max-w-[304px] !text-h1 leading-[50px] mx-auto">{TH.HERO.heading}</h2>
...
//               <p className="mt-6 lg:mt-11">
//                 {isVariant ? TH.DREAM_LIFE.copyVariant : TH.DREAM_LIFE.copy}
//               </p>
...
//           <h2 className="text-center capitalize mb-8">What's included in your membership:</h2>
...
//           <p className="max-w-[540px] mb-8 mx-auto">{TH.HERO.joinProgram}</p>
...
//         return (
//           <Form>
//             <div className={`flex flex-col space-y-4 lg:flex-row lg:justify-between items-center`}>
...
//                 <Text.Paragraph
//                   className={`max-w-[540px] text-center ${
//                     placement === 'bottom' ? 'text-white' : 'text-[#7B7B7B]'
//                   }`}
//                   content={TH.HERO.automaticRenewal}
//                 />
//               </div>
//             )} */}
