...
export const IAT_COPY = {
  ...
  relationship_section: {
    ...
    copy_left: `The Gibson Integrated Attachment Theory™ Certification Course is a revolutionary relationship coaching certification developed by Thais Gibson.
                ...
                \n***Spots for the Live Training version of the program running from January 17 - April 3, 2024 are limited.**`,
  ...
  initial_weeks: {
    ...
    content: [
      `How to discover a client’s needs and assist them in strategies for meeting them to create more fulfillment, relationship satisfaction, and rapid growth.`,

      `Results-oriented tools to help someone transform their attachment style into becoming securely attached.`,
      `The strategies and systems behind a fully booked coaching business.`,

      `Proven methods for subconscious reprogramming to help others release core wounds and painful limiting beliefs.`,

      `How to teach others the art of boundaries for improved self-esteem and healthier relationships in their lives.`,

      `Powerful tools to improve communication to help others de-escalate a conflict and to develop mastery of working through relationship challenges.`,

      `How to help others release relationship insecurities and build healthy relationships based on trust.`,

      `Knowing yourself better than ever, so you can experience more harmony and connection and create healthy relationships too.`,
    ],
  },
    ...
    live_training: {
      prerequisite_week: {
        ...
        week1: [
          ...
          `Attend 1-hour review session on January 17th, 6 PM ET`,
        ],

        week2: [
          `Complete course: Emotional Mastery Course Part 1`,

          `Attend 1-hour review session on January 24th, 6 PM ET`,
        ],

        week3: [
          `Complete course: Emotional Mastery Course Part 2`,

          `Attend 1-hour review session on January 31st, 6 PM ET`,
        ],

        week4: [
          `Complete course: Discover, Embrace and Fulfil Your Personal Needs`,

          `Attend 1-hour review session on February 7th, 6 PM ET`,
        ],
      },
      ...
      intensive_week: {
        ...
        copy: `After completing your prerequisites and content course webinars, you’ll start your live training with Thais from February 14 - April 3 every Wednesday at 6 PM ET for 8 weeks.
        ...
        features: {
          ...
          subheading: `As this is a rare opportunity to be trained directly by Thais, we are only able to offer limited seats for this training.`,

          copy: [
            `Our pre-recorded online training course (35+ hours of video content)`,

            `Practice sessions with Thais`,
  ...
  testimonials: [
    {
      review: `"Thais is a Human Whisperer!"\n\nCeren's experience led her to become a lifetime member of The Personal Development School. This endorsement speaks volumes about the effectiveness of the programs offered.`,
      author: 'Ceren Koca',
      designation: 'Senior Lead Behavioral Strategist',
      location: 'Google',
    },
    {
    ...
    {
      review: `"It is difficult to think of any aspect of one’s own life or the lives of our patients that would not benefit from Thais Gibson’s insights."\n\nDr. Blenk recognizes the power of Thais's work in synthesizing various psychological concepts, offering practical solutions for patients, and transforming their lives.`,
      author: 'Dr. Deborah Blenk',
      designation: '',
  ...
  certification: {
    title: `In short: all levels of experience are welcome! This course is for you if:`,

    bullets: [
      `You intend on building a successful coaching business`,
      `You are passionate about personal growth and helping others`,
      `You just want to drastically improve your own life and relationships`,
    ],

    copy: `The Integrated Attachment Theory™ Certification is for anyone who wants to become a relationship expert.
          \nIt’s designed to give you an in-depth education in attachment theory, communication, core wounds and conflict resolution.
          \nPlus, you’ll also learn how to build your own successful coaching business so you can be your own boss, gain financial independence and work online from anywhere in the world.
          \nThe certification can be used for 1:1 coaching, personal relationships, couples therapy, and more. It’s a flexible and comprehensive training that’ll walk you through relationship mastery.`,

    coaches: [
      {
        title: `ASPIRING COACHES`,
        copy: `Have no prior coaching experience? No problem! If you’d like to become a relationship expert and start your own coaching business, this is for you!`,
      },

      {
        title: `COACHES & THERAPISTS`,
        copy: `Want to improve your knowledge of attachment theory and use proven tools and techniques to help your clients overcome relationship issues?`,
      },

      {
        title: `INDIVIDUALS`,
        copy: `Want to learn more about your subconscious programming so you can heal and become masterful at creating meaningful relationships for life?`,
      },
    ],
  },
  ...
  price: {
    live_mode: [
      ...
      `3 months, 6 months and 12 months plans available.`,
    ...
    recorded_mode: [
      ...
      `Training on how to launch your coaching business and build systems that drive endless clients into your practice.`,
  ...
  itinerary: [
    {
      heading: `Prerequisite Week 1: The Handbook For A Better Life`,
    ...
    {
      heading: `Prerequisite Week 2: Emotional Mastery & Belief Reprogramming Course Part 1`,

      listItems: [
        `Your Subconscious Mind’s Reality Filter`,
    ...
    {
      heading: `Prerequisite Week 3: Emotional Mastery & Belief Reprogramming Course Part 2`,
    ...
    {
      heading: `Prerequisite Week 4: Discover, Embrace and Fulfill Your Personal Needs`,

      listItems: [
        `The 6 Basic Human Needs`,
        `Your Subconscious Personality Needs`,
    ...
    {
      heading: `INTENSIVE WEEK 1: MASTERING THE BASICS`,
      ...
      listItems: [
        ...
        `The 6 key areas in every person’s life that are necessary to target in order to become securely attached`,
    ...
    {
      heading: `INTENSIVE WEEK 2: GIBSON INTEGRATED ATTACHMENT THEORY™`,
      ...
      listItems: [
        ...
        `Key themes to help identify a clients’ attachment style fast`,
    ...
    {
      heading: `INTENSIVE WEEK 3: IDENTIFYING CORE WOUNDS & SECRETS OF THE SUBCONSCIOUS`,
    ...
    {
      heading: `INTENSIVE WEEK 4: REPROGRAMMING YOUR CLIENT'S ATTACHMENT STYLE`,
    ...
    {
      heading: `INTENSIVE WEEK 5: UNDERSTANDING SUBCONSCIOUS NEEDS & FORMING HEALTHY RELATIONSHIP HABITS`,
      ...
      listItems: [
        ...
        `How to identify the needs of your client so that they can learn to express and communicate them`,
    ...
    {
      heading: `INTENSIVE WEEK 6: ACTIVATING, DEACTIVATING & MASTERING CONFLICT RESOLUTION`,
    ...
    {
      heading: `INTENSIVE WEEK 7: UNLOCKING DEEPER CONNECTION`,
    ...
    {
      heading: `INTENSIVE WEEK 8: BUILD A THRIVING BUSINESS`,

      listItems: [
        `How to set up your business from the ground up - developing a mission statement, vision statement and business plan`,
        `How to operate your business with the key formula to produce results and expand fast`,
        `How to build large funnels and create powerful systems in your business to constantly drive traffic your way`,
      ...
      textTop: `In this final module, you’ll learn:`,
    },
  ],
  ...
  thais_section: {
    ...
    subsection: {
      ...
      copy: [
        ...
        `What does life look like in 1 year, 2 years, 5 years if you don’t gain the knowledge you need to design your life in the way that you want?`,
        `What would you do if you could work from anywhere in the world and could wake up each morning knowing that you were truly helping people in their personal lives and relationships? How would you feel?`,
      ],
    },
  },
  ...
  faq: [
    {
      answer: `Absolutely! This course is specifically designed for anyone new to coaching, but is also open to existing coaches and therapists who would like to learn more about attachment theory. Or to anyone who simply wants to gain emotional mastery and radically improve their relationships.`,
      question: `Can I join this training if I have no prior coaching experience?`,
    },

    {
      answer: `Yes! During this training, you'll learn everything you need to know so you can become a confident and skilled relationship coach. Plus, I'll share with you my best tips on how to set up a thriving coaching practice. And once you've received your certification, you'll be able to start coaching immediately.`,
      question: `Will I be able to start coaching right away?`,
    },

    {
      answer: `Once you've completed all the modules, you'll be invited to sit a multiple choice test. You'll receive your coaching certification if you obtain 60% or higher.`,
      question: `How do I get my certification?`,
    },

    {
      answer: `If you fail the test (get less than 60%), you can resit it a maximum of 3 times.`,
    ...
    {
      answer: `Absolutely! This training is yours to keep for life so you can refer back to it throughout your professional and personal life whenever needed.`,
      question: `Will I have lifetime access to this training?`,
    },

    {
      answer: ` Yes! You’ll receive many materials to help you organize your sessions, your business strategies and to create a framework to help you thrive.
        \nYou’ll also receive guidance materials and notes covering the basics of all the major tools and frameworks that you’ll learn.`,
      question: `Will I get materials to help me run coaching sessions?`,
    },
  ],
}
