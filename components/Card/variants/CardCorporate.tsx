...
//     <ScrollInAnimation
//       animateOnce
//       animateIn="anim-fade-in"
//       className={cx('card-sm', className)}
//       delay={type === 'report' ? 1000 : type === 'relationship' ? 2000 : 0}>
//       {type === 'time' && (
//         <Image className="w-28 lg:w-auto" src="images/CorporatePage/corporate_hourglass.svg" />
//       )}

//       {type === 'report' && (
//         <Image className="w-28 lg:w-auto" src="images/CorporatePage/corporate_report.svg" />
//       )}

//       {type === 'relationship' && (
//         <Image className="w-28 lg:w-auto" src="images/CorporatePage/corporate_relationship.svg" />
//       )}
...
//     // <ScrollAnimation
//     //   animateOnce
//     //   className={cx('card-md space-x-4 lg:space-x-8', className)}
//     //   animateIn="anim-styles">
//     <div className={cx('card-md anim-styles space-x-4 md:!flex-row lg:space-x-8', className)}>
//       {type === 'FA' && (
//         <Image className="w-auto" src="images/CorporatePage/corporate_landing_card_fa.svg" />
//       )}
//       {type === 'AP' && (
//         <Image className="w-auto" src="images/CorporatePage/corporate_landing_card_ap.svg" />
//       )}
//       {type === 'DA' && (
//         <Image className="w-auto" src="images/CorporatePage/corporate_landing_card_da.svg" />
//       )}
//       {type === 'SA' && (
//         <Image className="w-auto" src="images/CorporatePage/corporate_landing_card_sa.svg" />
//       )}
