  ...
  return (
    <html lang="en" className={`${effra.variable} ${sourceSerifPro.variable}`}>
      ...
      <Script
        ...
        src={`https://t.personaldevelopmentschool.com/v1/lst/universal-script?ph=b8a3426fb8e80314f3ba1bbeb78db76454a57084d1e165ba830f52cda229dd6b&tag=!clicked&ref_url=${encodeURIComponent(document.URL)}`}
        strategy="lazyOnload"
      />
