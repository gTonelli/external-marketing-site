...
const checkoutRoutes: Record<TCheckoutEnv, TCheckoutRoutes> = {
  production: {
    ...
    checkoutSep2025PromoTrial: `${checkoutUrl}/enroll/559833?price_id=4&bci=713808&promo_label=15d-breakup`,
  ...
  staging: {
    ...
    checkoutSep2025PromoTrial: `${checkoutUrl}/enroll/1934512?price_id=4&bci=3197987&promo_label=15d-breakup`,
